...
DATASET_NAME="emilia"
CONFIG_NAME="F5TTS_v1_Large_wav_x_pred_scale_8_aux_mel_w_0_05_noise_schedule_mean_1_2_std_1_16k"
EXP_NAME="${CONFIG_NAME}-from_noise_schedule_0_8_550k_pretrain-${DATASET_NAME}-${num_processes}gpus-${batch_size_per_gpu}sample_per_gpu-${mixed_precision}"
...
# bash /mnt/bn/jdy-lq-5/chenwenxi/code/F5_TTS_Wav_mel_dev/src/f5_tts/train/runs_emilia/run_large_scale_8_aux_mel_w_0_05_mean_1_2_std_1.sh
