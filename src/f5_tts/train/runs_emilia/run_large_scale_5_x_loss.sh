...
DATASET_NAME="emilia"
CONFIG_NAME="F5TTS_v1_Large_wav_x_pred_scale_5_aux_mel_noise_schedule_0_8_16k_x_loss"
...
# bash /mnt/bn/jdy-lq-5/chenwenxi/code/F5_TTS_Wav_mel_dev/src/f5_tts/train/runs_emilia/run_large_scale_5_x_loss.sh
