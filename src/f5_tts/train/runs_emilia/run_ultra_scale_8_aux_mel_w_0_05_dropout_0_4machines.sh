...
num_machines=4
total_gpus=$((num_processes * num_machines))
...
DATASET_NAME="emilia"
CONFIG_NAME="F5TTS_v1_Ultra_wav_x_pred_scale_8_aux_mel_w_0_05_noise_schedule_0_8_16k_dropout_0"
EXP_NAME="${CONFIG_NAME}-${DATASET_NAME}-${total_gpus}gpus-${batch_size_per_gpu}sample_per_gpu-${mixed_precision}"
...
# bash /mnt/bn/jdy-lq-5/chenwenxi/code/F5_TTS_Wav_mel_dev/src/f5_tts/train/runs_emilia/run_ultra_scale_8_aux_mel_w_0_05_dropout_0_4machines.sh
