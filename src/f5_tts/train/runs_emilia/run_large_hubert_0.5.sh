...
DATASET_NAME="emilia"
CONFIG_NAME="F5TTS_v1_Large_wav_x_pred_scale_aux_mel_hubert_0.5_noise_schedule_0_8_16k"
...
# bash /mnt/bn/jdy-lq-5/chenwenxi/code/F5_TTS_Wav/src/f5_tts/train/runs_emilia/run_large_hubert_0.5.sh
