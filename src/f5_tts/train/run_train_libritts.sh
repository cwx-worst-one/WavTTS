...
CONFIG_NAME="${CONFIG_NAME:-F5TTS_v1_Large_wav_x_pred_scale_8_aux_mel_w_0_05_noise_schedule_0_8_16k_dropout_0_joint_drop_0_1_LibriTTS}"
DATASET_NAME="${DATASET_NAME:-libritts}"
