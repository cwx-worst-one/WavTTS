...
CONFIG_NAME="F5TTS_v1_Base_wav_x_pred_scale_noise_schedule_0_8_16k_bottleneck_64"     # F5TTS_v1_Small, F5TTS_v1_Base, F5TTS_v1_Base_wav, F5TTS_v1_Base_wav_proj_input, F5TTS_v1_Base_wav_x_pred, F5TTS_v1_Small_mel_x_pred, F5TTS_v1_Base_wav_x_pred_proj_input
# EXP_NAME="${CONFIG_NAME}-${num_processes}gpus-${mixed_precision}-${batch_size_per_gpu}sample_per_gpu"            
EXP_NAME="debug_wav_x_pred_scale_noise_schedule_0_8_16k_bottleneck_128"   # debug_wav, debug_mel, debug_wav_proj_input, debug_wav_x_pred,
