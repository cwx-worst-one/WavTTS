...
# SEEDS=(0 1 2)
SEEDS=(0)
CKPTSTEPS=(500000)  # 550000, 700000, 900000
...
# GPUS="[0,1]"
OFFLINE_MODE=false
CKPT_PATH_DIR=/inspire/hdd/global_user/chenxie-25019/wenxichen/exp/f5_tts/F5TTS_v1_Huge_wav_x_pred_scale_aux_mel_noise_schedule_0_8_16k-8gpus-bf16-22400sample_per_gpu
