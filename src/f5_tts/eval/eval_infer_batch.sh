...
MODEL_NAME=F5TTS_v1_Ultra_wav_x_pred_scale_8_aux_mel_w_0_05_noise_schedule_0_8_16k
RESULT_MODEL_NAME="${MODEL_NAME}"
MEL_SPEC_TYPE="no_vocoder"
# SEEDS=(0 1 2)
SEEDS=(0)
CKPTSTEPS=(550000)  # 200000, 400000, 550000, 700000, 900000, 1000000, 1200000
...
# GPUS="[0,1,2,3]"
# GPUS="[0]"
TRAIN_GPU_TAG="32gpus"   # 8gpus, 16gpus, 32gpus
OFFLINE_MODE=false
CKPT_PATH_DIR=/mnt/bn/jdy-lq-5/chenwenxi/exp/nar_wav_tts/emilia/F5TTS_v1_Ultra_wav_x_pred_scale_8_aux_mel_w_0_05_noise_schedule_0_8_16k-emilia-32gpus-9600sample_per_gpu-bf16
...
execute_eval_tasks() {
    ...
    local gen_wav_dir="results/${RESULT_EXPNAME}/${ckptstep}/${task_name}/seed${seed}_euler_nfe${nfe_step}_${MEL_SPEC_TYPE}"
