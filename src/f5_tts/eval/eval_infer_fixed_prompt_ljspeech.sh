...
# bash src/f5_tts/eval/eval_infer_fixed_prompt_ljspeech.sh
# bash src/f5_tts/eval/eval_infer_fixed_prompt_ljspeech.sh --output-dir /mnt/bn/jdy-lq-5/chenwenxi/data/e2e_eval_result/WavTTS/ljspeech_inset_test_9s
