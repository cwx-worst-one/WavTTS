...
lang="en"  # en, zh, zh_hard
ckpt_step=550000    # 550000, 700000, 900000
nfe_step=32
cfg_strength=3.0
output_dir=/mnt/bn/jdy-lq-5/chenwenxi/code/F5_TTS_Wav/results/F5TTS_v1_Large_wav_x_pred_scale_aux_mel_noise_schedule_0_8_16k_audio_convmlp_inout/${ckpt_step}
