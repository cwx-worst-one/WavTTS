...
# python /mnt/bn/jdy-lq-5/chenwenxi/code/F5_TTS_Wav/src/wavtts/train/datasets/prepare_libritts.py
# python /inspire/hdd/global_user/chenwenxi-253108120142/code/F5_TTS_wav/src/wavtts/train/datasets/prepare_libritts.py
# python /inspire/hdd/global_user/chenxie-25019/wenxichen/code/F5_TTS_wav/src/wavtts/train/datasets/prepare_libritts.py