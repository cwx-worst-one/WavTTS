...
- Make a pull request adding a model card to the current page, i.e. `src\wavtts\infer\SHARED.md`.

<!-- omit in toc -->
### Supported Languages
- [Multilingual](#multilingual)
    - [F5-TTS v1 v0 Base @ zh \& en @ F5-TTS](#wavtts-v1-v0-base--zh--en--wavtts)
- [English](#english)
- [Finnish](#finnish)
    - [F5-TTS Base @ fi @ AsmoKoskinen](#wavtts-base--fi--asmokoskinen)
- [French](#french)
    - [F5-TTS Base @ fr @ RASPIAUDIO](#wavtts-base--fr--raspiaudio)
- [German](#german)
    - [F5-TTS Base @ de @ hvoss-techfak](#wavtts-base--de--hvoss-techfak)
- [Hindi](#hindi)
    - [F5-TTS Small @ hi @ SPRINGLab](#wavtts-small--hi--springlab)
- [Italian](#italian)
    - [F5-TTS Base @ it @ alien79](#wavtts-base--it--alien79)
- [Japanese](#japanese)
    - [F5-TTS Base @ ja @ Jmica](#wavtts-base--ja--jmica)
- [Mandarin](#mandarin)
- [Russian](#russian)
    - [F5-TTS Base @ ru @ HotDro4illa](#wavtts-base--ru--hotdro4illa)
- [Spanish](#spanish)
    - [F5-TTS Base @ es @ jpgallegoar](#wavtts-base--es--jpgallegoar)
...
- [Online Inference with Hugging Face Space](https://huggingface.co/spaces/RASPIAUDIO/wavtts_french).
