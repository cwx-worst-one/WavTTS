...
echo "======== Starting WavTTS fixed-prompt ls_pc_test_clean inference task..."
...
# bash src/wavtts/eval/eval_infer_fixed_prompt_ls_pc.sh
# bash src/wavtts/eval/eval_infer_fixed_prompt_ls_pc.sh --output-dir /mnt/bn/jdy-lq-5/chenwenxi/data/e2e_eval_result/WavTTS/ls_pc_test_clean
