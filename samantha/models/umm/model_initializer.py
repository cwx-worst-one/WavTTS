...
def init_bestrq_mel_ctc_vq(hpath, local_rank, cache_dir=None):
    from samantha.models.umm.lit_module import BestRQMelCTC
...
def init_mulan(hpath, local_rank, cache_dir=None):
    from samantha.models.umm.mulan_infer_g4 import create_mulan_model, mulan_inference
...
def init_stage1(hpath, local_rank, cache_dir=None):
    from samantha.models.umm.lit_module import Stage1
...
def init_stage2(hpath, local_rank, cache_dir=None):
    from samantha.models.umm.lit_module import Stage2
...
def init_stage3(hpath, local_rank, cache_dir=None):
    ...
    from samantha.models.umm.lit_module import Stage3
...
def init_stage3_mss(hpath, local_rank, cache_dir=None):
    ...
    from samantha.models.umm.lit_module import Stage3MSS
...
def init_mkii(hpath, local_rank, cache_dir=None):
    from samantha.models.umm.lit_module import MKIIVQ
...
def init_unified_decoder(hpath, local_rank, cache_dir=None):
    from samantha.models.umm.lit_module import UnifiedDecoder
