        ...
        if feat_type == "fbank":
            ...
            if config_path is None:
                ...
                if cache_dir is None:
                    cache_dir1 = "/home/tiger/.cache/torch/hub"
                    cache_dir2 = "/home/tiger/.cache/s3prl/download"
                else:
                    cache_dir1 = cache_dir
                    cache_dir2 = cache_dir

                self.feature_extract = torch.hub.load(
                    f"{cache_dir1}/s3prl_s3prl_main/",
                    feat_type,
                    path=f"{cache_dir2}/f2d5200177fd6a33b278b7b76b454f25cd8ee866d55c122e69fccf6c7467d37d.wavlm_large.pt",
                    source="local",
                )
            else:
