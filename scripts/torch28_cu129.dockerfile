...
FROM aliyun-va-hub.byted.org/base/lab.pytorch2:2.8.0.py312.cu129.post1 as aliyun_va
FROM use-hub.byted.org/base/lab.pytorch2:2.8.0.py312.cu129.post1 as us-east
FROM hub.tiktoke.org/base/lab.pytorch2:2.8.0.py312.cu129.post1 as us-east-red
FROM aliyun-sin-hub.byted.org/base/lab.pytorch2:2.8.0.py312.cu129.post1 as aliyun_sg
FROM hub.byted.org/base/lab.pytorch2:2.8.0.py312.cu129.post1 as china-north-lf
...
# Might interfere with Blackwell's 2SM GEMM..
...
RUN pip3 install setuptools==80.9.0
...
RUN pip3 install eventlet -U && \
        ...
        pip3 install byted-streaming==1.1.224 && \
        pip3 install byted-iceberg -U && \
        pip3 install py-spy -U

RUN pip3 install triton==3.4.0
...
COPY ./scripts/setup_wandb_312.sh .
RUN bash ./setup_wandb_312.sh
