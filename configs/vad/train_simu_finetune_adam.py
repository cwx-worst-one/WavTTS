...
data = dict(
    ...
    train_item_transform=[
        ...
        dict(
            type='AudioReplace',
            data_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liuyi/ts_vad/AliMeeting_data/pkg/wav/Train_Ali_far_reorder',
            shards_num=8,
            ...
            p=0.99),
            # data_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liuyi/ts_vad/AliMeeting_data/pkg/wav/Eval_Ali_far_reorder',
            # shards_num=1,
...
train = dict(
    ...
    save_name='resnet34_transformer_simu_finetune_1e-3',
    amp_level='O1',

    # The pretrained resnet
    resume_pretrain_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liuyi/ts_vad/AliMeeting_data/models/alimeeting_train/resnet34_transformer2_blstm2_real_freeze_adam_lr1e-3_wd1e-4/checkpoints/model_average.pth',
    resume='latest.pth',
