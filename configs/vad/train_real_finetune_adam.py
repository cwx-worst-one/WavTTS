...
train = dict(
    ...
    resume_pretrain_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liuyi/ts_vad/AliMeeting_data/models/alimeeting_train/resnet34_transformer2_blstm2_simu_finetune_adam_lr1e-4_wd1e-6/checkpoints/model_average.pth',
    resume='latest.pth',
