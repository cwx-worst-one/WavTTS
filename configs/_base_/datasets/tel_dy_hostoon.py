# dataset settings
data = dict(
    data_root = 'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/dolphin/dataset/tel_20200520_46kh_8k_expandsil/tel_dou' + \
            'yin_hostoon_80dim.fixed/',
    train_file_list = '["80dim_train_sub{}".format(i) for i in range(256)]',
    valid_file_list = '["80dim_cv"]',
