...
data = dict(
    data_root = 'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/tianyao/data/kws/for_h/eh_train0412/dolphin',
    train_file_list = '["train_sub{}".format(i) for i in range(99)]',
    valid_file_list = '["cv"]',
...
solution = dict(
    ...
    # jointer
    jointer_type='AdaptiveShallowJointer',
    rnnt_hidden_size=256,
    rnnt_softmax_hidden_size=256,
    adaptive_head_size=3,
    adaptive_tail_size=480,
    cutoff_groups=1,
    use_head_probs=False,
    # mtl head
    mtl_type='rnnt_ctc',
    ctc_weight=10.0,
