...
data = dict(
    data_root=[
        ...
        'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liboyu.622/traindata/text/dongchedi_selfv2/',
    ],
    # add ce sy+ctc label
    train_file_list = [
        '["train_sub{}".format(i) for i in range(1024)]',
        '["dongchedipart1_{}".format(i) for i in range(26)] + ["dongchedipart2_{}".format(i) for i in range(6)]',
    ],
    ...
    train_item_transform=[
        ...
        dict(type='LabelParser', in_key='text', out_key='label'),
...
train = dict(
    resume='latest.pth',
    resume_pretrain_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/huanglu.thu19/saved_models/dolphin/202207_text_adaptation/input10k_ilmt_tog_p0.2_mask0.15/checkpoints/step_400000.pth',
