project = "doc_context_rnnt"
runner = 'RNNTContextAwareRunner'

# increment to add and override args.
data = dict(
    data_root=[
        'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/gaohai/tts/xsum_new_rmtitle_updatekey/xsum_rmtitile_bodycontext_train_final/xsum_rmtitile_bodycontext_train_0_final',
        'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/gaohai/tts/xsum_new_rmtitle_updatekey/xsum_rmtitile_bodycontext_train_final/xsum_rmtitile_bodycontext_train_1_final',
        'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/gaohai/tts/xsum_new_rmtitle_updatekey/xsum_rmtitile_bodycontext_train_final/xsum_rmtitile_bodycontext_train_2_final',
        ],
    train_file_list=[
        '["sub_{}".format(i) for i in range(16)]',
        '["sub_{}".format(i) for i in range(16)]',
        '["sub_{}".format(i) for i in range(16)]',
        ],
    valid_data_root = [
        'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/gaohai/tts/xsum_new_rmtitle_updatekey/xsum_rmtitile_bodycontext_val_final'
        ],
    valid_file_list=['["sub_0"]'],
    test_data_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/gaohai/tts/xsum_new_rmtitle_updatekey/xsum_rmtitile_bodycontext_test_final',
    test_file_list=['["sub_0"]'],
    ...
    train_item_transform=[
        ...
        dict(type='DocBertTokenizer', key='context_text', out_key='context_text'),
    ...
    valid_item_transform=[
        ...
        dict(type='LabelLengthFilter', in_out_ratio=4),
        dict(type='BPE', use_eos=False, key='label', skip_list=['<fil/>', '<spk/>', '<sta/>', '<non/>', '<nps/>', '<space>', '<pad>', '[laughter]', '[noise]', '[vocalized-noise]']),
        dict(type='DocBertTokenizer', key='context_text', out_key='context_text'),
    ...
    batch_transform=[
        ...
        dict(type='DocSentCollate', key='context_text'),
...
solution = dict(
    ...
    # context encoder
    context_doc_emded_type='doc_rnn',  # doc_rnn word_average weight_sum_of_selfattn
    ...
    context_loss_scale=0.8,
    context_encoder_fixed=True,
    context_encoder_ckpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/gaohai/models/bert_xsum_epoch3/pytorch_model.bin',
    ...
    # Adaptive Softmax
    adaptive_head_size=4900,
    adaptive_tail_size=156,
...
train = dict(
    ...
    lr_scheduler=dict(
        ...
        policy='valid',
        gamma=0.8,
        step=[5000 + i * 5000 for i in range(80)]
        ),
    ...
    resume_pretrain_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/huanglu.thu19/saved_models/dolphin/hmm_free_paper/librispeech_lstm_rnnt_hmm_free_soft_ce_init_step2_determ2/checkpoints/latest.pth',
    save_root='./exp',
    save_dir='swbd2000',
    save_name='doc_ctx_model_v0',
    amp_level='O1',
    )
valid = dict(
    interval=5000, # iter
