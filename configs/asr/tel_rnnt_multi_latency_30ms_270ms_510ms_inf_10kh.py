data = dict(
    ...
    valid_file_list=['["cv"]', '["cv"]', '["cv"]', '["cv"]', '["cv"]'],
    ...
    next_retry=1024,
    bucket_schedule=
    '50,100,200,300,400,500,600,700,800,900,1000,1200,1400,1600,2000,2250,2500,2750,3000',
    bucket_schedule_val=
    '50,100,200,300,400,500,600,700,800,900,1000,1200,1400,1600,2000,5000,10000',
    bucket_schedule_key='fbank',
    batch_means_tokens=1,
    max_batch_size=30720,
    max_batch_scale=15,
    shuffle=True,
    drop_last=False,
    use_recombine=True,
    ...
    train_item_transform=[
        ...
        dict(type='WavParser', max_len=30.0),
        dict(
            type='AppendSilence',
            dur=0.2,
            sil_dir=
            'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/dolphin/dataset/xiansuotong_padding_silence',
            skip_enough=True,
            is_eos_sil_frame=True,
            sil_snr_max=60,
            sil_snr_min=40,
            sil_prefix='train_sub',
            sil_shards=16),
...
solution = dict(
    model_type='RnntMultiLatencyModel',
    ...
    conformer_mask_topology='[[128,0]]*9+[[128,128]]*3',
    stream_conformer_mask_topology='[[[128,0],[128,1],[128,2]]]*6+[[[128,0],[128,0],[128,0]]]*6',
    conformer_dual_mode=1,
...
train = dict(
    ...
    checkpoint_config=dict(
        interval=20000, max_local_keep_ckpts=5, max_hdfs_keep_ckpts=20),
    #remote_save_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/huanglu.thu19/saved_models/dolphin/',
    save_root='./demo',
    save_dir='dynamic_latency_ct',
    save_name='mr_30ms_270ms_510ms_inf_kd5e4',
    amp_level='O1')
valid = dict(interval=10000)
inference = dict(
    test_sets='../../tele/test/bytebot_test_set_20210318_18867',
    beam_size=10,
    lm_path='',
    lm_weight=1.0,
    blk_scale=1.0,
