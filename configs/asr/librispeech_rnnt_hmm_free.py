...
runner = 'RNNTRunner'
_base_ = [
    '../_base_/datasets/librispeech.py',
]
...
data = dict(
    ...
    train_item_transform=[
        ...
        dict(type='Backup', key='fbank'),
        dict(type='TimeMask', time_mask_size=20, time_mask_num=10, replace_with_zero=False),
        dict(type='FreqMask', freq_mask_size=27, freq_mask_num=1, replace_with_zero=False),
    ...
    batch_transform=[
        ...
        dict(type='FbankCollate', fbank_dim=80, reserve_frames=1, key='fbank_bak'),
...
solution = dict(
    ...
    teacher_head_type='RnntBaseHead',
...
train = dict(
    ...
    save_root='./demo',
    save_dir='librispeech_rnnt_pretrain',
