...
solution = dict(
    ...
    # Adaptive Softmax
    adaptive_head_size=1588,
    adaptive_tail_size=300,
    adaptive_tail_groups=15,
    # criterion
...
train = dict(
    ...
    # remote_save_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liangzhenlin/dolphin/english_23kh_rnnt_scratch_8card',
...
inference = dict(
    ...
    test_sets='lark_meeting_english|lark_english',
    beam_size=10,
    lm_path="",
    lm_weight=1.0,
    blk_scale=1.0,
