project = "nonstreaming_transformer_LAS"
runner = 'BaseLASRunner'
_base_ = [
    '../_base_/datasets/dy1wh.py',
]
...
train = dict(
    # resume_pretrain_chkpt='hdfs://haruna/home/byte_speech_sv/sami_sa_share/experiments/1_transformer_enc320ms_baseline/ckpts/avg-40-50.pth',
    # resume_pretrain_chkpt='hdfs://haruna/home/byte_speech_sv/sami_sa_share/experiments/1_transformer_enc320ms/ckpts/avg1-2.pth',
    ...
    save_root='./demo',
    save_dir='nostreaming_transformer_las',
...
inference = dict(
    ...
    ctc_max_len=True, # use ctc num of peak to decide decoding steps;
