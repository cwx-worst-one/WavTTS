...
solution = dict(
    ...
    acoustic_backbone_type='RelTransformerBackbone',
    # chunk_cfg
    chunk_mask=True,
    chunk_size=9,
    mem_size=27,
...
train = dict(
    ...
    #remote_save_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/xx/',
    save_root='./demo',
    save_dir='branch_model',
    save_name='chunk_wise_streaming_tt',
    amp_level='O1')
