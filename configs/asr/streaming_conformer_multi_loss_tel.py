...
solution = dict(
    ...
    las_args=dict(
        ...
        las_criterion_type='CTCLasCE',
        label_smooth_factor=0.1,
        normalize_length_loss=False,
    ),
)
work_dir = './demo'
train = dict(
    ...
    lr_scheduler=dict(
        ...
        policy='step',
        step=[350000 + 25000 * i for i in range(100)],
        gamma=0.85),
    checkpoint_config=dict(interval=10000, max_keep_ckpts=1000),
    save_root='./demo',
    save_dir='streaming_conformer',
    save_name='tfm_stream',
    amp_level='O1')
