...
data = dict(
    ...
    batch_transform=[
        ...
        dict(type='FbankCollate', fbank_dim=80, reserve_frames=1, key='fbank_bak', out_key='src_bak'),
...
train = dict(
    ...
    save_name='lstm_ce_new_xv',
    amp_level='O1',
    resume_hdfs_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/huanglu.thu19/saved_models/dolphin/tel_dou' + \
    'yin_hotsoon_80kh_rnnt_pretrain/blstm_ctc_new/checkpoints/best.pth',
    resume_progress=0)
