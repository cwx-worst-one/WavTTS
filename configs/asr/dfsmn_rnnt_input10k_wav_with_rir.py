...
train = dict(
    ...
    # resume_hdfs_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/chencanhua/dolphin/input1w_finetune_newbmuf_alignPKG2/dfsmnln_online_pretrain/ce_pretrain_shrink_epoch4/checkpoints/step_190000.pth',
    max_epochs=90,
    max_iters=2000000,
    lr_scheduler=dict(
        by_epoch=True,
    ...
    # remote_save_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/tianyao/dolphin/asr/input10k_wav_with_rir',
