project = "san_cif"
runner = 'CIFCePretrainRunner'

# increment to add and override args.
data = dict(
    data_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liangzhenlin/dolphin/cif_data_convert/input10k_token_ce/',
    ...
    valid_file_list = '["dev/train_sub0"]',
    ...
    batch_transform=[
        ...
        dict(type='CharCollate'),  # use it whether need pretrain cif part
    ],
...
solution = dict(
    model_type='BaseCIFPretrainModel',
    vocab_size=9353,
    downsampling_size=4,
...
train = dict(
    ...
    used_loss_names='ce_loss, quantity_loss',
    summary_freq=999999,
    logging_freq=100,
    ...
    save_checkpoint_freq=1600,
    total_train_step=60000,
    just_eval=False,
