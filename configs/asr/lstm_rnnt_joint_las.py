...
data = dict(
    ...
    use_bpe=True,
    data_root=[
        'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liangzhenlin/dolphin/data/aiot_12_9_data'
    ],
    ...
    meta_data_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/tangyu.yt/space/fixed_1w2_meta',
    meta_file='fixed_1w2.meta',
    fbank_dim=80,
