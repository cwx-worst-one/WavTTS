...
data = dict(
        data_root = 'hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liwanyu/nnlm_data_pkg_zh_tot/test_PPL_zh_text/',
    ...
    train_item_transform=[
        ...
        dict(type='BPE', use_eos=False, key='text', out_key='char'),
