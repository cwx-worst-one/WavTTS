project = 'wav2vec_pipeline_pretrain'
runner = 'Wav2vecPretrainPipelineRunner'
data = dict(
    data_root=[
...
solution = dict(
    ...
    wav2vec_type='PipelinePretrainedWav2Vec2',
    ...
    pipeline=dict(
        ...
        num_stages=2,
        # partition_method='manual:2:0,1,2',
...
work_dir = './w2v_pipeline_pretrain'
train = dict(
    # resume='latest.pth',
    ...
    save_dir='wav2vec2_base_pipe',
    save_name='base_10kh_lr5e-4_poly400k_mask0.65_len5_cat11.25s_bsz1.6h_v2_pipe',
