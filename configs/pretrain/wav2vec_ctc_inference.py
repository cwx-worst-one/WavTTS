project = 'wav2vec_ctc_base_inference'
...
data = dict(
    ...
    lexicon='lexicon.char2phonetone.txt',
    bpe_code="total.code",
    tgt_vocab_size=320,
    use_lid=False,
    fetch_block_size=300,
    bucket_schedule='50,2000',
...
solution = dict(
    type='base_wav2vec_ctc_solution',
    model_type='BaseWav2vecCtcModel',
    ...
    word_score=-1,
    lm_weight=2,
    wfst_graph='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/huangmingkun/lmdb_data/cantonese_noise1kh/wfst_graph/phonetone2char',
...
train = dict(
    ...
    # resume_hdfs_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhengyijie/saved_models/cantonese_noise1kh/wav2vec_finetune/converted_chkpt.pt',
    # resume_pretrain_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhengyijie/saved_models/cantonese_noise1kh/wav2vec_pretrain1kh/converted_chkpt.pt',
    # remote_save_root='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhengyijie/saved_models/dolphin/cantonese_unsup10kh/wav2vec_finetune/',
    save_root='./w2v_ctc/',
