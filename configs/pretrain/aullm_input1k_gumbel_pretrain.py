...
solution = dict(
    ...
    # lm (for discrete)
    gumbel_vocab_size=8192, # 和codebook一样大
...
train = dict(
    ...
    resume_pretrain_chkpt="hdfs://haruna/home/byte_arnold_hl_speech_asr/user/donglinhao/dolphin/models/"
                          "spokenlm_e2e_60kh/data2vec_25hz_encoder_gumbel_large_lm_exp2_bs15000_baselm_diversity100_temp1.0/"
                          "spokenlm_e2e_pretrain/spokenlm_e2e_pretrain/checkpoints/step_299200.pth",
    max_epochs=40,
    max_iters=150000,
    lr_scheduler=dict(
        by_epoch=False,
