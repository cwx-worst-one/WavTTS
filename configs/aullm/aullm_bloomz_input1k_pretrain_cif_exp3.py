...
train = dict(
    ...
    resume_pretrain_chkpt="hdfs://haruna/home/byte_arnold_hl_speech_asr/user/"
                          "donglinhao/dolphin/models/input1k/data2vec_finetuning/"
                          "cif_data2vec_finetune_supervised60k_large_bs12k_cif_exp1_25hz_2_fix_6layers_h640"
                          "/data2vec_cif/data2vec_cif/checkpoints/step_40000.pth",
    max_epochs=40,
    max_iters=40000,
    lr_scheduler=dict(
        by_epoch=False,
