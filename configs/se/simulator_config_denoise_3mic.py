...
rir_data = [
    dict(key="direct", prefix='circular_6mic_245mm', length=2048, unserialize_type='numpy_only', path='/mnt/bd/lgz-data/denoise_data/rir/circular_6mic_245mm'),
