...
data = dict(
    ...
    bucket_schedule='50,100,200,300,400,500,600,700,800,900,1000,1200,1400,1600,2000,5000,10000',
    ...
    train_item_transform=[
        ...
        dict(type='EmotionLabelParser', key='context', out_key='text'),
        dict(type='Textchar2Index', key='text'),
        dict(type='MaxLengthCut', key='text', max_len=80, keep_last=True, need_length=True),
    ...
    batch_transform=[
        ...
        dict(type='ListCollate', key='context'),
        dict(
            type='EmotionFeatCollate',
            key='waveform',
            out_key='input_values',
            mask_key='attention_mask',
        ),
        dict(type='EmotionFeatCollate', key='emotion_phone', mask_key='label_mask', pad=-100),
        dict(type='EmotionFeatCollate', key='text', mask_key='text_mask', pad=0),
    ],
...
solution = dict(
    ...
    model_type='MultimodalEmotionRecognitionModel',
    phone_num=60,
    phone_tag=2,
    emotion_num=6,
    ...
    tgt_size=362,
    neutral_label=1,
    predict_sets='t_emotion|a_emotion|m_emotion|mix_emotion',
    labels_sets='emotion',
    acoustic_mode='a_emotion_only',
    validation_set='m_emotion',
    fused_transformer=False,
    # m_emotion_dim = 896, #768+128 384
    t_emotion_dim=256,
    a_emotion_dim=768,
    a_drop_out=0.1,
    t_drop_out=0.1,
    ...
    activate_part_text_encoder=False,
    activate_part_acoustic_encoder=False,
    # bert_char2index=True,
    # bert_vocab_dict='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhousuping/iemocap_emotion/dolphin_data/saved_models/nlp_bert_vocab_8w.txt',
    bert_vocab_dict='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhousuping/iemocap_emotion/dolphin_data/saved_models/text_vocab_2w_to_8w.txt',
...
train = dict(
    ...
    resume_pretrain_chkpt='hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhousuping/iemocap_emotion/dolphin_data/saved_models/emotion_wav2vec/electra_1gpu_5e-6_v2v1/checkpoints/best.pth|hdfs://haruna/home/byte_arnold_hl_speech_asr/user/zhousuping/iemocap_emotion/dolphin_data/saved_models/emotion_wav2vec/set1_dainshang_wav2vec2_1e-5_emotion_phone/checkpoints/best.pth',
