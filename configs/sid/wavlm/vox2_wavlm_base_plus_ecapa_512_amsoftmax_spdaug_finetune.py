...
train = dict(
    ...
    save_root='wavlm',
    save_dir='vox2',
    save_name='wavlm_base_plus_ecapa_512_finetune',
    amp_level='O1',

    resume_pretrain_chkpt="hdfs://haruna/home/byte_arnold_hl_speech_asr/user/liuyi/wavlm/WavLM-Base+.pt",
    resume='latest.pth',
