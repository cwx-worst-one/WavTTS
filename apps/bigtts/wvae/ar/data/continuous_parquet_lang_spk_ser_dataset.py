...
class ContinuousTTSLangSpkSerDataset(IterableDataset):
    def __init__(
        ...
        self.dataset = (
            ParquetDataset(data_id=int(data_id), resampled=True)
            .shuffle(2048)
...
if __name__ == "__main__":
    ...
    dataset = ContinuousTTSLangSpkSerDataset(
        data_id=373,
        batcher_config=batcher_config,
        drop_last=False,
        use_lang_id=False,
        lang2id="apps/bigtts/wvae/ar/resources/lang2id.json",
        use_spk_id=True,
        spk2id="apps/bigtts/wvae/ar/resources/spk2id.parquet.json",
        input_type="2dim",
        use_code_switch_data=True,
        use_extra_tag=True,
        spk2tag="apps/bigtts/wvae/ar/resources/spk2tag.parquet.json",
        use_sp=False,
        refenc_cfg_rate=0.0,
    )
