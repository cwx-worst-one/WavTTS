...
bash launch.sh fit --config apps/bigtts/speechdit/conf/ACD.yaml \
		...
		--disc_cls.hidden_dim 256 \
		--disc_cls.n_layers 2 \
		--disc_cls.n_heads 4 \
		--run_opts.g_learning_rate 0.000008 \
		--run_opts.d_learning_rate 0.000008 \
		--distill_config.ema_decay 0.99 \
		--distill_config.cfg_drop_rate 0.1 \
		--distill_config.p_target_x0 0.1 \
