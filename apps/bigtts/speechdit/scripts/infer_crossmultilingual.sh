...
out_dir=/mnt/bn/lxdnas-lq/jacobdunn/cla/${lang}_video_processed/${syn_lang}_tts_raw

# 有前端的情况
meta_lst=/mnt/bn/lxdnas-lq/jacobdunn/cla/${lang}_video_processed/${syn_lang}_outputs/meta_source_audio_${lang}2${syn_lang}.lst
# 无前端
# meta_lst=/mnt/bn/lxdnas-lq/jacobdunn/cla/${lang}_video_processed/${syn_lang}_outputs/meta_source_audio_${lang}2${syn_lang}_tacolab.lst

# out_dir=/mnt/bn/lxdnas-lq/jacobdunn/cla/${lang}_mp4_video_ast/${syn_lang}_tts_raw
# meta_lst=/mnt/bn/lxdnas-lq/jacobdunn/cla/${lang}_mp4_video_ast/${syn_lang}_outputs/meta_source_audio_${lang}2${syn_lang}.lst
mkdir -p $out_dir
