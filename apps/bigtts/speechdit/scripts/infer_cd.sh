...
#exp=CD_350MDIT_EMA0.99_lr8e-6_guide4_N50_Huber1_Fixed
#ckpt="epoch=00-step=140000-loss=0.004.ckpt"
#step=140000

#exp=CD_350MDIT_EMA0.99995_lr8e-6_guide4_N50_Huber1_Fixed
#ckpt="epoch=00-step=50000-loss=0.004.ckpt"
#step=50000

#exp=CD_350MDIT_EMA0.99995_lr8e-6_guide4_N50_Huber1_Fixed_CFG0.1DisableODE
#ckpt="epoch=00-step=70000-loss=0.002.ckpt"
#step=70000

#exp=CD_350MDIT_EMA0.99995_lr8e-6_guide4_N50_Huber1_Fixed_CFG0.1
#ckpt="epoch=00-step=140000-loss=0.008.ckpt"
#step=140000

#exp=CD_350MDIT_EMA0.99_lr8e-6_guide4_N50_Huber1_Fixed_CFG0.1
#ckpt="epoch=00-step=60000-loss=0.011.ckpt"
#step=60000
...
#out_dir=$out_dir/$exp/icl_testset_2.0_${syn_lang}/$step/${sampler}_${nfe}steps_CFG${cfg}_AdaLength_${prompt_mode}_uniform_order2_single_dpm
