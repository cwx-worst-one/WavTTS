...
```
mkdir .deploy_cache
hdfs dfs -get hdfs://haruna/home/byte_data_seed/lf_lq/speech/checkpoints/user/zhuangxiaobin/v2a_deploy/* .deploy_cache
...
wave = v2a_model.inference(frames) # 默认 cfg = 7.5， steps = 50，可以调到 30
