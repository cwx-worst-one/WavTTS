...
from apps.bigtts.umm.ar.infer.base_modules import BaseContinuousEmbedModule
...
class SemanticModule_Valle(BaseContinuousEmbedModule):
    def __init__(
        ...
        self.use_lang_embedding = use_lang_embedding = extra_params.get('use_lang_embedding', True)
        ...
        if use_lang_embedding:
            ...
            print(f"======= do not use lang_embeddings...")
