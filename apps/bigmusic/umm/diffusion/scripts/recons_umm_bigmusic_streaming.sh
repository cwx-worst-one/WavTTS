...
# version=h800_ds1609_prompt_16xH800_streaming_chunk100_lr5e-5_v2_0229
# diffusion_ckpt_path=${diffusion_ckpt_base_dir}/${version}/checkpoints/epoch=00-step=70000-loss=0.38.ckpt
# cfg_path=apps/bigmusic/umm/diffusion/conf/infer_reconstruction_50hzDualConv_125hzSS_streaming.yaml
# sub_dir=exp4_streaming_70k
