...
from apps.bigmusic.umm.ar.datasets.mcc import INDEX

try:
    from apps.bigmusic.umm.ar.datasets.mcc.sami_tokenizer import convert_labels_to_text_id
except:
    print("[WARNING] Failed to import convert_labels_to_text_id")
import logging

from apps.bigmusic.umm.ar.datasets.transforms.audio import FastNormalizeAudio, LoudnessCheck
    ...
    def __init__(
        ...
        if tokenizer == "wordpiece":
            ...
            self.tokenizer = AutoTokenizer.from_pretrained(
                "instru/umm/tokenizer_bbpe64k-0303"
            )
        else:
            self.tokenizer = None
        self.frame_rate = frame_rate
