...
from apps.bigmusic.umm.ar.utils.utils import hash_trick, length_to_mask
...
class UMMTokenizer(LightningModuleBase):
    ...
    def __init__(self, finetune: bool = False, cache_dir: str = ".cache"):
        ...
        self.model = self.get_model(self._hdfs_path[ARNOLD_REGION], cache_dir)
    ...
    @staticmethod
    def get_model(hpath: str, cache_dir: str):
