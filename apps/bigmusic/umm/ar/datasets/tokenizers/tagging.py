...
from apps.bigmusic.umm.ar.datasets.mir.tagging import TaggingDataResult, TaggingDataModule
...
from apps.bigmusic.umm.ar.datasets.tokenizers.tokenizers import UMMTokenizer, UMMResult, MusicTagTokenizer, MusicTagTokenizerResult
