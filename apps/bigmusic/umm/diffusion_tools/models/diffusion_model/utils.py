...
from apps.bigmusic.umm.diffusion_tools.models.tnt_gru import (
    TNTDiffusionNetwork as ZhTNTDiffusionNetwork,
)
from apps.bigmusic.umm.diffusion_tools.models.tnt_mss import (
    TNTDiffusionNetwork as TNTDiffusionNetworkMSS,
)
from apps.bigmusic.umm.diffusion_tools.models.tnt_mulan_free import TNTDiffusionNetwork
from apps.bigmusic.umm.diffusion_tools.models.tnt_v2 import (
    TNTDiffusionNetwork as TNTDiffusionNetworkV2,
)
from samantha.utils.utils import download_checkpoint
from apps.bigmusic.umm.diffusion_tools.modules.pl_module import DiffusionModule
...
def init_diffusion(
    ...
    with rank_zero_first():
        ...
        if sstk:
            ...
            diffusion_model = load_ema_checkpoint(local_path, diffusion_network)
...
def run_diffusion(requires, samples, params):
    ...
    wavs_g = torch.cat(
        [vocoder.decode(c).detach() for c in torch.split(pred_emb, batch_chunks)]
    )
