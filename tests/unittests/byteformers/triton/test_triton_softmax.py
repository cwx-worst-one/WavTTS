...
try:
    from samantha.byteformers.triton.softmax import log_softmax as triton_log_softmax
    from samantha.byteformers.triton.softmax import softmax as triton_softmax
