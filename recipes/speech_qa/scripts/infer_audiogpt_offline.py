...
def main():
    ...
    for _token_file in os.listdir(args.input_dir):
        ...
        semantic_samples = speech_continuation(semantic_model, prompt_tokens, args.token_size)
...
if __name__ == "__main__":
    ...
    # Checkpoint paths
    ckpts = {}
    from recipes.speech_qa.lit_modules.audiogpt.lit_audiogpt_merge import SemanticModule
