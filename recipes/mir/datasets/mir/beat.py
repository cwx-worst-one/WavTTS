...
class BeatDataModule(MIRDataModuleBase):
    ...
    _directories = {
        "train": [
            "beat/ballroom_beat_24kHz/train",
            "beat/beatles_beat_24kHz/train",
            "beat/hainsworth_beat_24kHz/train",
            "beat/hjdb_beat_24kHz/train",
            "beat/karaoke_beat_24kHz/train",
            "beat/rwc_beat_24kHz/train",
            "beat/simac_beat_24kHz/train",
            "beat/smc_beat_24kHz/train",
            "beat/harmonix_beat_24kHz/train",
            # "beat/karaoke_beat_vocal_24kHz/train", # Different task
        ],
        "validation": [
            "beat/gtzan_beat_24kHz/validation",
            "beat/clip500_beat_24kHz/validation",
            "beat/bytebeat_beat_24kHz/validation",
            # "beat/MCC126_beat_24kHz/validation", # Different task
        ],
        "test": [
            "beat/gtzan_beat_24kHz/test",
            "beat/clip500_beat_24kHz/test",
            "beat/bytebeat_beat_24kHz/test",
            # "beat/MCC32_beat_24kHz/test", # Different task
        ],
    }
    _sample_rate = 24000
