...
def error_correct(chord):
    ...
    chord = (
        ...
        .replace(":(13)", ":maj")
        .replace(":(3)", ":maj")
        .replace(":(1,4,b7)", ":7sus4")
        .replace(":(#5)", ":aug")
        .replace(":min9(sus4)", ":9sus4")
        .replace(":(1,2,5,b6)", ":sus2")
        .replace(":(1,5)", ":maj")
        .replace(":(1,5,9)", ":maj")
        .replace(":min7(sus4)", ":7sus4")
        .replace("Ab:Gb", "Ab:maj")
        .replace(":m7b5", ":hdim")
        .replace("7:(sus4)", ":7sus4")
        .replace("m7?5", "hdim")
        .replace("7:(sus4）", "7sus4")
        .replace(":(1,b3)", ":min")
        .replace(":(11)", ":maj")
        .replace(":(1)", ":maj")
        .replace(":(1,b3,b5,6)", ":hdim")
        .replace(":(7)", ":7")
        .replace(":(6)", ":maj")
        .replace(":(b3,5)", ":min")
        .replace(":(5)", ":maj")
        .replace(":7ssu4", ":7su4")
        .replace(":min7b5", ":hdim")
        .replace(":(b3,b7,11,9)", ":min7")
        .replace("", "")
        .replace(":min//C#", ":min/C#")
        .replace("E:bmaj", "Eb:maj")
        .replace(":m7♭5", ":hdim")
        .replace(":7♭9", ":7")
        .replace("A::maj/C#", "A:maj/C#")
        .replace("G#:,maj", "G#:maj")
        .replace(":min7C", ":min7")
        .replace(":7b9", ":7")
        .replace("C::maj/Bb", "C:maj/Bb")
        .replace(":addj9", ":add9")
        .replace("::9(sus4)", ":9sus4")
        .replace("9:(sus4)", ":9sus4")
        .replace(":(7sus4)", ":7sus4")
        .replace(":,min", ":min")
        .replace(":dihdim", ":hdim")
        .replace(":m7add13", ":min7")
        .replace(":m7(add13)", ":min7")
        .replace(":majG", ":maj")
        .replace(":majF", ":maj")
        .replace(":7su4", ":7sus4")
        .replace(":,maj", ":maj")
...
def get_chord_labels(chords, intervals, hop_in_sec):
    ...
    if intervals[-1][1] < 1:
        end_idx = np.floor(intervals[-1][0] * hop_per_sec).astype(np.int32)
    else:
        end_idx = np.floor(intervals[-1][1] * hop_per_sec).astype(np.int32)
    oup = {}
    (
        oup["root_labels"],
        oup["triad_labels"],
