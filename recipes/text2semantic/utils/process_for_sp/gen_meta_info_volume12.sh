...
mkdir -p /mnt/bd/huangzhiying-lq-valle-volume12/data/bytegen/valle/libri_light/meta_info/
...
ii=0
job_num=128
for x in {1801..2540};do
    [ -f /mnt/bd/huangzhiying-lq-valle-volume12/data/bytegen/valle/libri_light/meta_info/meta.$x.json ] && continue
    echo $x
    {
    wav2taco=/mnt/bd/huangzhiying-lq-valle-volume12/data/bytegen/valle/libri_light/by_split/wav2taco2text.$x
    meta=/mnt/bd/huangzhiying-lq-valle-volume12/data/bytegen/valle/libri_light/meta_info/meta.$x.json
