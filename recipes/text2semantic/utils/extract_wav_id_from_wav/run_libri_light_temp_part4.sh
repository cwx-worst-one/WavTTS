...
for x in {0..7};do
    python3 /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/valle/utils/extract_wav_id_from_wav/norm_trim_ts.py \
                            ...
                            /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/valle/utils/extract_wav_id_from_wav/wav_uniq_vad_asr_by_shards/wav.list.part4.$x \
                            $x \
                            /mnt/bd/huangzhiying-lq-librilight-ss50hz-part4/data/bytegen/soundstream/libri_light/wav_ids_norm_trim_50hz/ \
                            /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/valle/utils/extract_wav_id_from_wav/wav_uniq_vad_asr_by_shards/wav2split.part4.$x &
done
wait
