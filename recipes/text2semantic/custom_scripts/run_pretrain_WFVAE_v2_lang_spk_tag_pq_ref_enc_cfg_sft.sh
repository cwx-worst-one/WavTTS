...
if [ ${stage} -eq 1 ];then
    ...
    version=data_id${data_id}_bt${batch_total_tokens}_16A100_accu5_scr${spk_cfg_rate}_ref_enc_cfg${refenc_cfg_rate}_${spk_type}
    ...
    base_config="--config recipes/text2semantic/conf/llama/vae_llama_ctiga_parquet_lang_spk_tag_ser.yaml \
                ...
                --run_opts.spk_type ${spk_type} \
                --run_opts.use_ref_enc ${use_ref_enc} \
                --trainer.benchmark False \
                --run_opts.refenc_cfg_rate ${refenc_cfg_rate}"
...
# infer seed1996
if [ ${stage} -eq 2 ];then
    hdfs_path=hdfs://haruna/home/byte_data_seed/lf_lq/speech/user/huangzhiying.92/exp/samantha_bigtts_ref_enc/text2semantic/pretrain_WFVAE_v2_labv3_punc_data_id373_bt14000_16A100_accu5_scr0.0_ref_enc_cfg0.15_concat
    local_path=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha_bigtts_ref_enc/text2semantic/pretrain_WFVAE_v2_labv3_punc_data_id373_bt14000_16A100_accu5_scr0.0_ref_enc_cfg0.15_concat
