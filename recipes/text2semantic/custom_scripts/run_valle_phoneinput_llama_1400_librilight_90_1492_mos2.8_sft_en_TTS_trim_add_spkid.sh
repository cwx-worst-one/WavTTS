...
train_meta_lst=/mnt/bd/huangzhiying-lq-valle-volume7/data/bytegen/valle/en_TTS_trim/meta_list_all.txt.add_metalen.fiter_90_1492.shuf.train.add_spkid
valid_meta_lst=/mnt/bd/huangzhiying-lq-valle-volume7/data/bytegen/valle/en_TTS_trim/meta_list_all.txt.add_metalen.fiter_90_1492.shuf.valid.add_spkid
...
if [ ${stage} -eq 1 ];then
    cd $work_dir
    log_name="ar"
    version="fp16_lr4e-4_batch${batch_total_tokens}_sft_en_TTS_trim_add_spkid"
...
if [ ${stage} -eq 2 ];then
    cd $work_dir
    log_name="nar"
    version="fp16_lr5e-5_batch${batch_total_tokens}_sft_en_TTS_trim_add_spkid"
