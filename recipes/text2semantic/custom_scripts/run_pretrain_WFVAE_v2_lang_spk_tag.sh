...
bash launch.sh fit \
        ...
        --run_opts.data_id 237 \
        --run_opts.hdfs_path hdfs://haruna/home/byte_data_seed/lf_lq/speech/user/huangzhiying.92/exp/samantha_bigtts_merge20231008/text2semantic/pretrain_WFVAE_v2_labv3_punc_data_id237_bt14000_16A100_accu5_byteT5_scr0.15_freezeTrue_langFalse_test \
        --run_opts.log_dir ./logs \
        --run_opts.log_name pretrain_WFVAE_v2_labv3_punc \
        --run_opts.version data_id237_bt14000_16A100_accu5_byteT5_scr0.15_freezeTrue_langFalse_test \
        ...
        --run_opts.wds2tag recipes/text2semantic/datasets/urls_lst/wds2tag.data_id237.json \
        --run_opts.spk_cfg_rate 0.15 \
