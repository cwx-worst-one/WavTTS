...
dataname=libri_light_norm_trim-923h
...
if [ ${stage} -eq 3 ];then
    cd $work_dir
    coarse_dir=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha/valle/valle_phoneinput_libri_light_norm_trim-923h-A100-80GB-3-8/ar/fp16_lr4e-4_batch140000/checkpoints/
