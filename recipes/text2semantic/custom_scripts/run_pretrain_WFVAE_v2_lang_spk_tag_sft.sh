...
if [ $mode == "debug" ]; then
    work_dir=/mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha_bigtts_wvae_sft_tobe_merge
fi
...
if [ ${stage} -eq 1 ];then
    ...
    version=data_id${data_id}_bt${batch_total_tokens}_16A100_accu5_byteT5_scr${spk_cfg_rate}_freeze${freeze_text_encoder}_lang${use_lang_id}
    hdfs_path=hdfs://haruna/home/byte_data_seed/lf_lq/speech/user/huangzhiying.92/exp/samantha_bigtts_wvae_sft_tobe_merge/text2semantic/${log_name}_${version}
...
# infer seed1996
if [ ${stage} -eq 2 ];then
    # hdfs_path=hdfs://haruna/home/byte_data_seed/lf_lq/speech/user/huangzhiying.92/exp/samantha_bigtts_wvae_sft_tobe_merge/text2semantic/sft_WFVAE_v2_labv3_punc_data_id289_bt14000_16A100_accu5_byteT5_scr0.0_freezeTrue_langFalse_20231022
    # local_path=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha_bigtts_wvae_sft_tobe_merge/text2semantic/sft_WFVAE_v2_labv3_punc_data_id289_bt14000_16A100_accu5_byteT5_scr0.0_freezeTrue_langFalse_20231022
    ...
    local_path=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha_bigtts_wvae_sft_tobe_merge/text2semantic/sft_WFVAE_v2_labv3_punc_data_id307_bt14000_16A100_accu5_byteT5_scr0.0_freezeTrue_langFalse
    ...
    for infer_spk_name in duibiao/xudong_1024_update duibiao/sinong_conversation duibiao/sophie_conv_1019 duibiao/M100_conversation duibiao/maomao_conv_1024_update;do
        infer_spk_basename=`echo $infer_spk_name | cut -d "/" -f 2`
        tag_id=3
        # for pair in temp_en-conversation_en_zh_200;do
        for pair in temp_en-guoqing_en_zh_74;do
            cd $work_dir
            if [[ ! -d ./resource ]]; then
                hdfs dfs -get hdfs://haruna/home/byte_data_seed/lf_lq/speech/user/panjunjie.jeff/resource ./resource
            fi
