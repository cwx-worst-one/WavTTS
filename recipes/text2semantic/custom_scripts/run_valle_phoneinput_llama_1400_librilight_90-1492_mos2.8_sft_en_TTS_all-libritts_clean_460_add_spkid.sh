...
train_meta_lst=/mnt/bn/huangzhiying-nas-speech2speech-volume1/data/bytegen/valle/en_TTS_all-libritts_clean_460/meta_list_all.txt.add_metalen.shuf.train.fiter_90_1492.add_spkid.wer0.1
valid_meta_lst=/mnt/bn/huangzhiying-nas-speech2speech-volume1/data/bytegen/valle/en_TTS_all-libritts_clean_460/meta_list_all.txt.add_metalen.shuf.valid.fiter_90_1492.add_spkid.wer0.1
...
if [ ${stage} -eq 1 ];then
    cd $work_dir
    log_name="ar"
    version="fp16_lr4e-4_batch${batch_total_tokens}_sft_en_TTS_all-libritts_clean_460_add_spkid"
    ...
    base_config="--config /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/bark/conf/llama/valle_coarse_llama_sft_add_spkid.yaml \
                    ...
                    --hp.spk_dict /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/valle/datasets/dict/spk_en_TTS_all-libritts_clean_460.json \
                    --hp.spk_num 1500 \
                    --llama_config.vocab_size_tobe_resize 2727 \
                    --llama_config.out_dim_tobe_resize 2727"
...
### will-librispeech_test_clean_minlen
if [ ${stage} -eq 3 ];then
    cd $work_dir
    spk_id=SAMI_will
    testspk=will
    ...
    coarse_dir=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha/valle/valle_phoneinput_1400_librilight_90-1492_mosnet2.8-A100-80GB-3-8/ar/fp16_lr4e-4_batch100000_sft_en_TTS_all-libritts_clean_460_add_spkid/checkpoints
    ...
    for rank in {0..7};do
        ...
        python3 recipes/valle/scripts/infer_valle_pre-nar_raw_spkid_minlen.py \
            ...
            --spkid $spk_id \
            --spk_dict_path /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/valle/datasets/dict/spk_en_TTS_all-libritts_clean_460.json
        }&
    done
    wait
