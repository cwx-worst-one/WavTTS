...
if [ ${stage} -eq 1 ];then
    log_name=sft_WFVAE_v2_labv3_punc_0.3b
...
# infer seed1996
if [ ${stage} -eq 2 ];then
    hdfs_path=hdfs://haruna/home/byte_data_seed/lf_lq/speech/user/huangzhiying.92/exp/samantha_bigtts_ref_enc/text2semantic/sft_WFVAE_v2_labv3_punc_data_id539_bt14000_16A100_accu5_scr0.0_spTrue
