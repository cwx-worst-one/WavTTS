...
if [ ${stage} -eq 1 ];then
    ...
    version=${dataname}_bt${batch_total_tokens}_32A100_accu2
...
# infer seed1996
if [ ${stage} -eq 2 ];then
    hdfs_path=hdfs://haruna/home/hcache/centralize_lq/gpt_java/speech/user/huangzhiying.92/exp/samantha_bigtts_merge/text2semantic/pretrain_labv3_punc_ll-rp-fq-others_bt17500_32A100_accu2
    local_path=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha_bigtts_merge/text2semantic/pretrain_labv3_punc_ll-rp-fq-others_bt17500_32A100_accu2
