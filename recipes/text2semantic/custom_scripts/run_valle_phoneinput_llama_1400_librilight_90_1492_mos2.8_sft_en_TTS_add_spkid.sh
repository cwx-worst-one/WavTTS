...
train_meta_lst=/mnt/bn/huangzhiying-nas-speech2speech-volume1/data/bytegen/valle/en_TTS/meta_list_all.txt.add_metalen.fiter_90_1492.shuf.train.add_spkid
valid_meta_lst=/mnt/bn/huangzhiying-nas-speech2speech-volume1/data/bytegen/valle/en_TTS/meta_list_all.txt.add_metalen.fiter_90_1492.shuf.valid.add_spkid
...
if [ ${stage} -eq 1 ];then
    cd $work_dir
    log_name="ar"
    version="fp16_lr4e-4_batch${batch_total_tokens}_sft_en_TTS_add_spkid"
    ...
    base_config="--config /mnt/bn/huangzhiying-nas-speech2speech-volume1/code/samantha/recipes/bark/conf/llama/valle_coarse_llama_add_spkid.yaml \
...
if [ ${stage} -eq 2 ];then
    ...
    base_config="--config recipes/valle/conf/valle_phoneme_fine_dynba_sft_add_spkid.yaml \
                --run_opts.train_meta_lst $train_meta_lst \
...
if [ ${stage} -eq 5 ];then
    cd $work_dir
    ar_ckpt_path=/mnt/bn/huangzhiying-nas-speech2speech-volume1/exp/samantha/bark/valle_phoneinput_1400_librilight_90-1492_mosnet2.8-A100-80GB-3-8/ar/fp16_lr4e-4_batch140000/checkpoints/last.ckpt
    ar_ckpt_dir=`dirname $ar_ckpt_path`
    nar_ckpt_path=/mnt/bn/jcong5/logs/sami_ai_models/valle_phoneinput_1400_librilight_90-1492--1-8/nar/fp16_lr5e-5_batch15000/checkpoints/last.ckpt
    nar_ckpt_dir=`dirname $nar_ckpt_path`
    ...
    for rank in {0..7};do
        {
        python3 recipes/bark/scripts/infer_valle_pre-nar_raw_spkid.py \
