...
from recipes.text2semantic.scripts.infer_utils import prepare_models, save_wav, to_device, get_step_epoch_from_ckpt
import librosa
...
def main(args):
    device = args.device
    ar_model, nar_model, vqgan =  prepare_models(args, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--phone_token_num", default=200)
    parser.add_argument("--audio_token_num", default=1024)
