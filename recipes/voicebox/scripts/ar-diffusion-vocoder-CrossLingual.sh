...
tag=exp1_AR600k_UMMv02_icl_test_2.0_${prompt_lang}2${syn_lang}
ar_predict_token_path=/mnt/bn/jdy-lq-2/bigtts-nar/ar_output/$tag
meta_lst=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_2.0/${prompt_lang}2${syn_lang}_meta.lst 
prompt_wav_dir=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_2.0/${prompt_lang}

out_dir=/mnt/bn/jdy-lq-2/bigtts-nar/output
out_dir=$out_dir/$exp/${tag}/$step/ddim_steps
mkdir -p $out_dir
...
bash launch.sh predict \
    ...
    --predict_dataset.prompt_lang $prompt_lang \
