...
tag=speech_umm_sami_t0.9_p0.9_ar130k_zh2en_v0.6.2_lang_stable_audiometric_sample
...
if [ $1 == 'en' ]; then
    ...
    echo 'src = en, tgt = en'
	lang=en
	meta_lst=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/meta_${lang}.txt
	prompt_wav_dir=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/${lang}
	...
	lang=zh
    # meta_lst=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/meta_${lang}.txt
    meta_lst=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/meta_${lang}.punc.txt
	prompt_wav_dir=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/${lang}
	...
	tgt_lang=en
	lang=$tgt_lang
    # meta_lst=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/meta_${src_lang}2${tgt_lang}.txt
    meta_lst=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/meta_${src_lang}2${tgt_lang}.punc.txt
	prompt_wav_dir=/mnt/bn/jdy-lq-2/bigtts-nar/repo/bigtts_testset/icl_testset_demo_2.0/${src_lang}
...
#bash recipes/voicebox/scripts/eval.sh $meta_lst $out_dir $tgt_lang
#exit
