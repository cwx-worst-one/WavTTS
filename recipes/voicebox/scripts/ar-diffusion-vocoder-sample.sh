...
tag=speech_umm_sami_t0.9_p0.9_ar50k_zh_v0.6.2_lang_sample
...
if [ $1 == 'en' ]; then
    ...
    echo 'src = en, tgt = en'
	test_wav_dir=/mnt/bn/mam/kainan/umm/llama/infer/prompt_EN_origin/
	text_file=/mnt/bn/mam/kainan/umm/llama/infer/en_120_origin.pyt

elif [ $1 == 'zh' ] ; then

    echo 'src = zh, tgt = zh'
	test_wav_dir=/mnt/bn/mam/kainan/umm/llama/infer/prompt_ZH_origin/
	text_file=/mnt/bn/mam/kainan/umm/llama/infer/zh_80_origin.pyt
