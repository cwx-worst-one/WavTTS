...
class MusicFM75Hz(nn.Module):
    ...
    def __init__(
        ...
        super(MusicFM75Hz, self).__init__()
        ...
        self.conv = Conv2dSubsampling(1, conv_dim, encoder_dim, strides=[2, 1], n_bands=n_mels)
    ...
    def masking(self, x):
        ...
        len_masking_token = int(24000/self.hop_length/2 * self.mask_hop)
    ...
    def rearrange(self, x):
        ...
        for key in x.keys():
            if key == "chromagram":
                ...
                x[key] = rearrange(x[key], "b f (t s) -> b t (s f)", s=2)
        return x
