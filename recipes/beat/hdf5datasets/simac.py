...
class SimacDataset(BeatHDF5Dataset):
    """
    Simac Dataset
    """

    DATASET_NAME = "simac_beat"
    LABEL_DIR = "simac_beats"
    _HDFS_DIRS = {
        "audio": "hdfs://harunava/home/byte_speech_sv/data/"
        "SheetDoctor/audio_h5/simac_audio.h5",
    ...
    def _load_example(self, key):
        # read annotations
        with open(os.path.join(self.label_dir, "simac_beats", key + ".txt")) as f:
            beats = f.readlines()
