...
_HDFS_DIRS = {
    ...
    "SheetDoctor/h5/salamijazz_audio.h5",
    "structure_labels": "hdfs://harunava/home/byte_speech_sv/data/"
    "SheetDoctor/labels/salami_function_segments.zip",
}


class SalamiJazzDataset(AbstractStructureDataset):
    """
    Salami Jazz Dataset
    """

    DATASET_NAME = "salamijazz_structure"
    DATASET_ROOT_DIR = "/mnt/bn/mir-tasks/structure/salamijazz_structure/"
