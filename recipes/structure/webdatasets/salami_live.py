...
_HDFS_DIRS = {
    ...
    "SheetDoctor/h5/salamilive_audio.h5",
    "structure_labels": "hdfs://harunava/home/byte_speech_sv/data/"
    "SheetDoctor/labels/salami_function_segments.zip",
}


class SalamiLiveDataset(AbstractStructureDataset):
    """
    Salami Live Dataset
    """

    DATASET_NAME = "salamilive_structure"
    DATASET_ROOT_DIR = "/mnt/bn/mir-tasks/structure/salamilive_structure/"
