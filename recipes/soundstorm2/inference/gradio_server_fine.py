...
def generate_audio(
    ...
    with torch.no_grad():
        tmp_tokens = torch.cat((coarse_audio_tokens, torch.zeros(coarse_audio_tokens.shape[0], 8, coarse_audio_tokens.shape[2], dtype=coarse_audio_tokens.dtype, device=coarse_audio_tokens.device)), dim=1)
