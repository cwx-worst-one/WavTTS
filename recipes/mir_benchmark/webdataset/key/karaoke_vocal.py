"""
Karaoke Vocal Key Recognition Dataset.
"""
...
class KaraokeVocalDataset(AbstractWebDatasetGeneratorBasedBuilder):
    """
    Karaoke Vocal Dataset with fixed labels
    """

    SAMPLING_RATE = 24000
    DATASET_NAME = "karaoke_key_vocal_24kHz"
    ...
    def _load_example(self, _id):
        ...
        try:
            audio_path = os.path.join(self.audio_dir, "lead_vocal", _id[1:] + ".mp3")
