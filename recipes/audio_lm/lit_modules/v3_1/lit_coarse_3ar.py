...
from ...requires.mulan.mulan_infer_newer import mulan_inference, mulan_rvq_indexs
...
class CoarseModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.local_rank == 0:
            print("Coarse 3AR Training, new mulan...")
    ...
    def prepare_feature(self, wavs):
        ...
        # mulan_tokens 12 + eos 1 + w2v 247 + eos 1 + ss 2000
