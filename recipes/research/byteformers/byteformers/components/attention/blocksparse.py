...
if _is_blocksparse_available:
    from samantha.utils.triton.blocksparse import matmul as blocksparse_matmul  # type: ignore
    from samantha.utils.triton.blocksparse import softmax as blocksparse_softmax  # type: ignore
