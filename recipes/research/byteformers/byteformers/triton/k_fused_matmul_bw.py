...
from .k_activations import gelu_grad, leaky_relu_grad, relu_grad
...
def fused_matmul_backward(
    ...
    assert grad_out_.shape[1] == weight.shape[0], "Incompatible dimensions"
    ...
    grad_in = torch.matmul(grad_out_, weight)
