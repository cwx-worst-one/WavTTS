...
def process_row_group(row_group_no):
    ...
    for row in group_datas.iterrows():
        ...
        uttid = values.uttid
        audio = values.audio
        mp3_bytes = wav_bytes_to_mp3_bytes(audio)
...
if __name__ == "__main__":
    ...
    target_dir = "hdfs://harunava/home/byte_data_seed_us/hdd_va/speech/data_store/BigMusic/music_everynoise_N937k_Lmix_mp3/data"
