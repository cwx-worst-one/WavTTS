...
HDFS_BASE = "hdfs://harunava/home/byte_speech_sv/jingsong.gao/mcc_gpt_generated"


def get_gpt_generated_list():
    # mcc_music_to_gpt_generated_captions.json
    with open("mcc_music_to_gpt_generated_captions.json", "r") as f:
...
def packer():
    while True:
        ...
        start = time()
        output_path = f"{HDFS_BASE}/mcc_gpt_generated_{i:02d}.tar"
        # parse file system
