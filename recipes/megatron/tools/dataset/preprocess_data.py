...
def get_args():
    ...
    group.add_argument(
        ...
        type=str,
        default=None,
        help="sentencepeice tokenizer model, huggingface tokenizer name/path.",
    )
    group.add_argument(
        "--pad-vocab-size-to",
        type=int,
        ...
        "Value of the size of the vocabulary of the tokenizer to "
        "reach. This value must be greater than the initial size "
        "of the tokenizer and divisible by `make_vocab_size_divisible_by`.",
    )
    group.add_argument(
    ...
    if args.tokenizer_type.lower().startswith("bert"):
        if not args.split_sentences:
            print(
                "Bert tokenizer detected, are you sure you don't want to split sentences?"  # noqa
            )
