...
from recipes.bigmusic.datasets.lyrics import LyricsCollator
from recipes.bigmusic.lightning.inference import ConditionalMulanPhonemeInferenceModule
...
if __name__ == "__main__":
    ...
    cfg
    if cfg is None:
        cfg = load_config("recipes/bigmusic/conf/inference_mulan_phoneme.yaml", overrides)
