...
raw_dictionary_hdfs_path = "hdfs://harunava/home/byte_speech_sv/andrew.shaw/l2s/data/cmu/cmu_dict.txt"
...
class CMUPhonemeTokenizer(object):
    def __init__(self, allow_unknown=False, hdfs_path=dictionary_hdfs_path, cache_dir='.module_cache'):
    ...
    def __call__(self, text):
        ...
        phonemes = [word_to_phonemes(self.dictionary, w, self.allow_unknown) for w in words]
