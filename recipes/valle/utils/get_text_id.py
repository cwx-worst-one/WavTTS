...
from babble.datasets.building.text.encoding import enc_taco_label_no_bytes, enc_fs_label
from tqdm import tqdm
import json

metaid_to_textid_path="/mnt/bn/jcong5/workspace/bytegen/dict/metaid_to_textid.json"
...
with open(metaid_to_textid_path, "w") as f:
