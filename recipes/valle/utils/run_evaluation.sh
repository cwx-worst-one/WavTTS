...
### cal_wer
cd /mnt/bn/huangzhiying-nas-volume1/code/samantha/recipes/speartts/utils/
python3 cal_wer.py $wav_res_ref_text_path $wav_res_ref_text_path.wer
tail -n 1 $wav_res_ref_text_path.wer
echo
cd -

### cal_asv
cd /mnt/bn/huangzhiying-nas-volume1/code/UniSpeech/downstreams/speaker_verification
...
# ### cal naturalness
# cd /mnt/bn/huangzhiying-nas-volume1/code/NISQA
