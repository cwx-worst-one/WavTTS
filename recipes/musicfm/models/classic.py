...
from recipes.musicfm.modules.features import MFCC, Chromagram, MelSTFT
...
class ClassicMusicFM(nn.Module):
    ...
    def __init__(
        ...
        self.preprocessor_mfcc = MFCC(n_fft=n_fft)
        self.preprocessor_chromagram = Chromagram(n_fft=n_fft)  # already average pooled
