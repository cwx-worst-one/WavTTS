...
from recipes.musicfm.modules.features import MFCC, Chromagram, ChromaticSTFT, MelSTFT
...
class BEST_RQ(nn.Module):
    ...
    def __init__(
        ...
        self.quantizer_melspec = RandomProjectionQuantizer(
            n_mels, codebook_dim, codebook_size
        )  # mel spec
        ...
        self.conv = Conv2dSubsampling(
            1, conv_dim, encoder_dim, strides=[1, 1], n_bands=n_mels
        )
    ...
    def masking(self, x):
        ...
        len_masking_token = int(24000 / self.hop_length * self.mask_hop)
