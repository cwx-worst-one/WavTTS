...
class SubbandMusicFM(nn.Module):
    ...
    def __init__(
        ...
        self.preprocessor_melspec = MelSTFT(n_fft=n_fft, n_mels=n_mels)

        # two residual convolution layers + one projection layer
        self.conv = Conv2dSubsampling(1, conv_dim, encoder_dim, n_mels)
    ...
    def get_predictions(self, x):
        ...
        # encoding
        logits, hidden_emb = self.encoder(x["melspec"].unsqueeze(1))
