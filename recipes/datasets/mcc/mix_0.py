...
class MixWebDataModule(pl.LightningDataModule):
    def __init__(
        ...
        if fast_dev:
            ...
            if weights[0] > 0:
                if small:
                    ...
                    print('Load mcc vocal dataset with weight '+str(weights[0]))
                datasets.append(
            ...
            if weights[1] > 0:
                ...
                print('Load librilight dataset with weight '+str(weights[1]))
                datasets.append(
            ...
            if weights[2] > 0:
                ...
                print('Load MCCInstrumentalDataset dataset with weight '+str(weights[2]))
                datasets.append(
        ...
        print('Load KaraokeDataset dataset')
        ...
        print('Load LibriTTSDataset dataset')
