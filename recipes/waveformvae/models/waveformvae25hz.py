...
class SpecAccelerator(nn.Module):
    def __init__(self, in_channels, out_channels, hidden_channels):
        ...
        self.net_1 = modules.WN(hidden_channels=hidden_channels,
                                ...
                                n_layers=4,
                                p_dropout=0.1)
        self.down = Downsample(down_scale=3, in_channels=hidden_channels, out_channels=hidden_channels * 2)
...
class WaveformVAE(nn.Module):
    def __init__(self,
        ...
        with open(os.path.join("recipes", "waveformvae", "conf", "bigvgan25hz.json")) as f:
            data = f.read()
