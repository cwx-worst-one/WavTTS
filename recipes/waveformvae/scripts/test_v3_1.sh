...
ckpt_path='hdfs://haruna/home/byte_speech_sv/user/cjw/WaveformVAE/v3_1/epoch=00-step=426000.ckpt'
input_dir=$1
output_dir=$2
...
mv epoch=00-step=426000.ckpt logs/v3_1/
mkdir -p $output_dir

config_path='logs/hparams.yaml'
ckpt_path='logs/v3_1/epoch=00-step=426000.ckpt'

CUDA_VISIBLE_DEVICES=0 python3 recipes/waveformvae/scripts/test_v3_1.py \
    --config_path $config_path \
    --ckpt_path $ckpt_path \
    --input_dir $input_dir \
    --output_dir $output_dir

# WAV_RES_REF_TEXT_PATH=/mnt/bn/cjw-lq-1/project/jiawei/temp/samantha/logs/v3_1/wav_res_ref_text_librispeech_test
