...
class TriStageLR(_LRScheduler):
    """
    Warm up LR linearly from `lr * init_lr_scale` to `lr`
    for the first `warmup_steps` iters.
    Then hold LR constant at `lr` for `hold_steps` iters.
    ...
    https://github.com/facebookresearch/fairseq/blob/
    main/fairseq/optim/lr_scheduler/tri_stage_lr_scheduler.py
    """
