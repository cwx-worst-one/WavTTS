...
class MomentumUpdaterHook(Hook):
    ...
    def __init__(self, by_epoch=True, warmup=None, warmup_iters=0, warmup_ratio=0.9, **_kwargs):
        '''init.'''
...
class CosineAnealingMomentumUpdaterHook(MomentumUpdaterHook):
    '''Cosine Anealing Momentum Updater Hook.'''
...
class CyclicMomentumUpdaterHook(MomentumUpdaterHook):
    ...
    # NOTE(liyong): should be fixed later.
    def get_momentum(self, runner, base_momentum):
