...
class CephBackend(BaseStorageBackend):
    ...
    def __init__(self, path_mapping=None):
        ...
        try:
            ...
            raise ImportError('Please install ceph to enable CephBackend.') from ie
...
class PetrelBackend(BaseStorageBackend):
    ...
    def __init__(self, path_mapping=None):
        ...
        try:
            ...
            raise ImportError('Please install petrel_client to enable PetrelBackend.') from ie
...
class MemcachedBackend(BaseStorageBackend):
    ...
    def __init__(self, server_list_cfg, client_cfg, sys_path=None):
        ...
        try:
            ...
            raise ImportError('Please install memcached to enable MemcachedBackend.') from ie
    ...
    def get(self, filepath):
        filepath = str(filepath)
        import mc  # pylint: disable=import-error
...
class LmdbBackend(BaseStorageBackend):
    ...
    def __init__(self, db_path, readonly=True, lock=False, readahead=False, **kwargs):
        ...
        try:
            ...
            raise ImportError('Please install lmdb to enable LmdbBackend.') from ie
